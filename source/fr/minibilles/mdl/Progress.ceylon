...
shared class Progress (
    ...
    shared Boolean indeterminate = false,
    ...
    id, progressClazz(clazz, indeterminate),
...
Attribute<String> progressClazz(Attribute<String> clazz, Boolean indeterminate) {
    variable [String+] toAdd = ["mdl-progress", "mdl-js-progress"];
    if (indeterminate) { toAdd = toAdd.withTrailing("mdl-progress__indeterminate"); }
